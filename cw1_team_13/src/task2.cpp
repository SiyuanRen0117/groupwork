  ...
  cw1_team_13::task2_start::Response &response)
{
  ...
  left_corner.position.x = 0.2;
  left_corner.position.y = 0.4;
  left_corner.position.z = 0.4;
  left_corner.orientation = grasp_orientation;

  geometry_msgs::Pose right_corner;
  right_corner.position.x = 0.5;
  right_corner.position.y = 0.4;
  right_corner.position.z = 0.4;
  right_corner.orientation = grasp_orientation;
  
  

  bool success_move_left = moveArm(left_corner);
  ROS_INFO_STREAM(success_move_left);
  ROS_INFO("SUCCESSSSSSSSSSSSSSSSSSSSS MOVE LEFT");
  
  bool success_move_right = moveArm(right_corner);
  ROS_INFO_STREAM(success_move_right);
  ROS_INFO("SUCCESSSSSSSSSSSSSSSSSSSSS MOVE LEFT");
...
////////////////////////////////////////////////////////////////////////////////
void
PCLTask::segCylind (PointCPtr &in_cloud_ptr)
{
